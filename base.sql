...
-- Listage de la structure de la base pour cleanfx
CREATE DATABASE IF NOT EXISTS `cleanfx` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci */;
USE `cleanfx`;

-- Listage de la structure de table cleanfx. ban
